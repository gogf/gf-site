...
hide_title: true
sidebar_position: 7
keywords: [GoFrame框架,统一返回结构,JSON格式,接口数据结构,路由函数,中间件定义,执行结果,错误处理,示例代码,接口文档生成]
description: '使用GoFrame框架统一接口返回结构，以JSON格式返回数据，定义接口数据结构和路由函数，使用中间件处理执行结果，并提供完整的示例代码。通过这些方法，可以在业务项目中实现统一的数据格式封装，简化接口文档的生成和维护过程。'
---
